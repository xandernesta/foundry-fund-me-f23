...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(RPC_URL_INFURA_SEP) --account $(ACCOUNT_MM) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
